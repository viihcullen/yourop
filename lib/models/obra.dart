class Obra{
  ...
  Obra({this.idObra, this.tituloObra, this.resumoObra, this.idDiretor, this.idEscritor});
}
...
class ObraCategoria{
  ...
  ObraCategoria({this.idObraCategoria, this.idObra, this.idCategoria, this.obraCategoria = const []});
}